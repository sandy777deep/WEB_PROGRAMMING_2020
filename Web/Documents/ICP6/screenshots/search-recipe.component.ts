...
// for the location search we are limiting the location to 8 results
    if (this.placeValue != null && this.placeValue !== '' && this.recipeValue != null && this.recipeValue !== '') {
      ...
      this._http.get(`https://api.foursquare.com/v2/venues/search?client_id=R0DXXKM5BTJMRK3HRXMCRZ3QK3UG3LM1AUDLHDNEBQZRCYTZ&client_secret=IOWJRGIHCVO2UIYKFLPQCRL3WDYIEDX1FJVLET2J3XMRHLHT&v=20180323&limit=8&near=${this.placeValue}`).subscribe((result: any) => {
        console.log(result);
